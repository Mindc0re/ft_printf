...
/*   Updated: 2016/02/18 11:49:47 by dvirgile         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/ft_printf.h"

int		base_long_2(t_docker *data, long int result, int base, uint8_t flag)
{
	FT_INIT(int, prec, 0);
	...
	if (data->less == 1)
	{
		...
		ftp_putbase_long(result, base, flag, data->dieze);
...
int		base_long(t_docker *data, long int result, int base, uint8_t flag)
{
